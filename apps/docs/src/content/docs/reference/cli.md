...
Removal obtains a fresh safety preview. `--force` confirms reported warnings when cleanup is still eligible; see [removing a worktree](/guides/removing-a-worktree/).
